...
const questions = [
  ...
  // {
  //   id: 4,
  //   question: "Поможет ли сайт вашему бизнесу",
  //   answer: ``,
  // },
  {
    id: 5,
    question: "Сколько стоит разработка сайта?",
    answer: `<p>Стоимость зависит от того какие возможности будут на сайте</p> </br>
        <p>Будет ли возможность: <p>• Добавлять товары в корзину, в избранное</p> <p>• Оформить заказ </p> <p>• Заказ обратного звонка </p> <p>• Сортировка товаров и тд ... </p> </p> </br>
        <p>При заполнении брифа, вы отмечаете тот функционал, который хотите видеть. Так вы получите сайт, который будет закрывать именно ваши задачи и не переплатите</p>`,
  },
];
